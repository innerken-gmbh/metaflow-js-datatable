  ...
  <div style="position: relative">
    <div class="d-flex " v-if="showTitle">
      <div
          ...
          :class="mobileView? 'pb-4' : 'py-4 pb-6'"
      >
        <slot name="navigation"></slot>
        <span
            class="font-weight-bold text-truncate"
            :class="!mobileView? 'text-h2 ' : 'text-h3'"
        >
        ...
        <slot v-if="mobileView" name="primaryButton">
          <v-btn
              ...
              v-if="useDefaultAction && useAddAction && !onlyDisplay"
              elevation="0"
    ...
    <template v-else>
      ...
      >
        ...
        >
          ...
          <v-btn
              small
              :color="filterDisplayChips.length>0?'amber lighten-4 black--text':''"
              @click="showFilter=true"
    ...
    <general-form
        ...
        :model="model"
        :use-delete-action="useDefaultAction&&useDeleteAction&&!onlyDisplay"
        @need-refresh="reload"
        ...
        <div class="pa-4">
          ...
          <v-card flat v-else min-height="400">
            ...
            >
              ...
              <div class="mt-4">
                <v-btn elevation="0" color="amber lighten-4 black--text"
                       min-width="120"
...
export default {
  ...
  computed: {
    ...
    canMassEdit: function () {
      return this.editableFields.length > 0 && this.useDefaultAction&&!this.onlyDisplay
    },
  ...
  mounted () {
    ...
    if (this.useCustomAction || this.useDefaultAction &&
        (this.useEditAction || this.useDeleteAction)&&!this.onlyDisplay) {
      this.headers.push({
        text: ' ',
        width: '60px',
        value: 'action',
  ...
  methods: {
    ...
    editItem (item) {
      ...
      if (this.useDefaultAction && this.useEditAction&&!this.onlyDisplay) {
